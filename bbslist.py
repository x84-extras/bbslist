...
This script was made by Dingo for x/84 v1.x. It contains obsolete code to
support the now defunct bbs-scene.org api. This code can be ignored but
keep in mind that the script is unsupported and you use it on your own
risk.
